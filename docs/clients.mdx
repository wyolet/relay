...
| [Claude Code](/claude-code) | `http://localhost:8080/claude-code` | `/claude-code/v1/messages`, plus model discovery and the startup probe |
| [Codex CLI](/codex) | `http://localhost:8080/codex/v1` | `/codex/v1/responses` |
| [OpenCode](/opencode) | `http://localhost:8080/opencode/v1` | `/opencode/v1/chat/completions` or `/opencode/v1/messages`, plus the model catalog at `/opencode/api.json` |
